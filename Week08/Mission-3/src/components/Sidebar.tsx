  ...
  return (
    <>
      ...
      >
        ...
        {accessToken && (
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-red-400 hover:bg-red-500/10 hover:text-red-300 transition text-sm"
          >
      ...
      {isConfirmOpen && (
        <ConfirmModal
          title="회원 탈퇴"
          description={"정말 탈퇴하시겠습니까?\n탈퇴 시 모든 게시글, 댓글, 좋아요가 삭제되며 복구할 수 없습니다."}
